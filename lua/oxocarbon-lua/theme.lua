...
Theme.set_general_highlights = function(colors)
	...
	highlight("@punctuation.delimiter", 9, none)
	highlight("@punctuation.bracket", 9, none)
	highlight("@punctuation.special", 9, none)
	highlight("@repeat", 10, none)
	highlight("@string", 15, none)
	...
	highlight("@text.literal", 5, none)
	highlight("@text.emphasis", 11, none, { "bold" })
	...
	highlight("@strong", 13, none, { "bold" })
	highlight("@comment", 19, none, conditional_italic)
	...
	-- TreeSitter
	highlight("TSURI", 14, none)
	highlight("TSLiteral", 19, none)
	highlight("TSTextReference", 11, none)
	highlight("TSTitle", 13, { "bold" })
	highlight("TSEmphasis", 9, { "bold" })
